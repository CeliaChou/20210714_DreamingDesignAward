...
$('.step3_02_square').each(function () {
    var $table = $(this);
    var itemsPerPage = 20;
    var currentPage = 0;
    var pages = Math.ceil($table.find(".step3_02_square_list").length / itemsPerPage);
    ...
    $table.find(
    '.step3_02_square_list').hide().slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage).show();
    });
